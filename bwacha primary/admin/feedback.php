            ...
            <div class="container px-5 py-10 mx-auto">
                <div class="flex flex-col text-center w-full mb-5">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-blue-600">School's Feedback</h1>
                     ...
                     Explore the Admin Panel for Bwacha Primary School's Feedback System. Efficiently manage and analyze user feedback from the website, facilitating informed decisions for continuous improvement. Take charge of enhancing the school's educational experience and shaping its future.</p>
                </div>
            </div>
        </section>
