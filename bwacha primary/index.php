...
<head>
    ...
    <title>Home|Bwacha Primary School</title>
...
<?php include('includes/header.php') ?>
    ...
    <div class="mx-auto">
        ...
        <div id="default-carousel" class="relative" data-carousel="static">
            <!-- Carousel wrapper -->
            <div class="overflow-hidden relative h-56 sm:h-64 xl:h-95 2xl:h-96 ">
                <!-- Item 1 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <span
                        class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-gray-800">First
                        Slide</span>
                    <img src="assects/images/schoolImages/bwacha.jpg"
                        class="object-co block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 "
                        alt="...">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="assects/images/schoolImages/bwacha 2.jpeg"
    ...
    <h1
        class="mt-8 ml-5 mb-4 text-xl text-4xl font-bold leading-none tracking-tight text-blue-600 md:text-5xl lg:text-2xl dark:text-black text-center">
        BWACHA PRIMARY SCHOOL</h1>
    <p class="text-justify ml-5 mr-5 text-base font-normal text-black-500 lg:text-xxx dark:text-black-400">
        <?php echo $row['one']; ?></p>
