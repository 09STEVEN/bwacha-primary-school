...
<head>
    ...
    <title><?php echo $_SESSION["selectedAlbum"]; ?></title>
...
<div class="bg-white dark:bg-gray-600 h-full py-6 sm:py-8 lg:py-2">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
            <div class="flex items-center gap-12">
                ...
                <p class="hidden max-w-screen-sm text-gray-100 dark:text-gray-300 md:block">
