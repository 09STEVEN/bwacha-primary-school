        ...
        <section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-0 mb-10">
            ...
            <div style="display: none;" id="alert-additional-content-3"
                ...
                <div class="mt-2 mb-4 text-sm">
                    ...
                    Our Bwacha administrator will contact you soon for the admission process. Kindly visit our school
            ...
            <form class="hide_after_submission" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input placeholder="Full name's" required name="full_name" type="text"
                    ...
                    <div>
                        ...
                        <input placeholder="eg.kabwata house No12" id="address" required name="address" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">Father's name <span
                                style="color: red;">*</span></label>
                        <input placeholder="Full name's" name="father_name" required type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">Mother's Name <span
                                style="color: red;">*</span></label>
                        <input placeholder="Full name's" name="mother_name" required type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    ...
                    <div>
                        ...
                        <input placeholder="Lusaka Primary School" name="previous_school" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
                        <label class="text-white dark:text-gray-200">Email</label>
                        <input placeholder="example@gmail.com" id="email" name="email" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    ...
                    <div>
                        <label class="text-white dark:text-gray-200">Phone No. <span
                                style="color: red;">*</span></label>
                        <input placeholder="+260 000000000" id="phone" required name="phone" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
